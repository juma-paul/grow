...
export default function Onboarding() {
  ...
  return (
    <div className="absolute inset-0 z-10 flex items-center justify-center">
      <div className="flex flex-col items-center gap-4 rounded-xl border border-[#262d3d] bg-[#171b24] px-8 py-6 shadow-2xl max-w-xs text-center">
        ...
        <p className="text-[13px] leading-relaxed text-[#8b90a0]">
        ...
        <span className="text-[10px] text-[#565b6b]">
